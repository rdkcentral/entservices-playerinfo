...
apt update
apt install -y valgrind lcov clang libsystemd-dev meson curl libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev
pip install jsonref
...
git clone --branch https://$GITHUB_TOKEN@github.com/rdkcentral/entservices-testframework.git

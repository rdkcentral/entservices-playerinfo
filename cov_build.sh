...
############################
# Build entservices-playerinfo
echo "======================================================================================"
echo "buliding entservices-playerinfo"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-playerinfo \
-DUSE_THUNDER_R4=ON \
...
-DENABLE_DEEP_SLEEP -DHAS_API_SYSTEM -DHAS_API_POWERSTATE \
-DUSE_THUNDER_R4 -DTHUNDER_VERSION=4 -DTHUNDER_VERSION_MAJOR=4 -DTHUNDER_VERSION_MINOR=4" \

cmake --build build/entservices-playerinfo --target install
echo "======================================================================================"
exit 0
